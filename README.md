...
1. Keep the spacing in front of each line consistent with the previous content;
2. Add only the basic domain name starting with `+.`, such as: `+.github.com` insteads `www.github.com`
